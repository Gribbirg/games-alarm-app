...
import com.example.smartalarm.core.data.model.WeekCalendarData
...
import com.example.smartalarm.core.data.repositories.CalendarRepository
import com.example.smartalarm.core.data.repositories.getDayOfWeekNameVinit
import com.example.smartalarm.core.data.repositories.getMontNameVinit
import com.example.smartalarm.core.data.repositories.getTodayNumInWeek
...
class AlarmsFragmentViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun timesToString(alarmsList: ArrayList<AlarmSimpleData?>): ArrayList<String> {
        return com.example.smartalarm.core.data.repositories.timesToString(alarmsList)
    }
