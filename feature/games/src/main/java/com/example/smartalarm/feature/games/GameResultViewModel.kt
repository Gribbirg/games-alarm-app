...
import com.example.smartalarm.core.data.repositories.getCurrentDateString
import com.example.smartalarm.core.data.repositories.getCurrentTimeString
import com.example.smartalarm.core.data.repositories.getTodayDate
    ...
    fun setGameResult(alarmId: Long, gameId: Int, score: Int, time: String) {
        viewModelScope.launch {
            ...
            if (alarm.activateDate == null) {
                ...
                alarmDbRepository.deleteAlarmFromDb(AlarmSimpleData(alarm))
            }
        }
    }
