...
dependencies {
    ...
    implementation(project(":feature:games:matrix"))
    implementation(project(":feature:games:mole"))
    implementation(project(":feature:games:pattern"))
    implementation(project(":feature:games:weekday"))
    implementation(project(":feature:games:percent"))
    implementation(project(":feature:games:binary"))
    implementation(project(":feature:games:reverse"))
    implementation(project(":feature:games:capitals"))
    implementation(project(":feature:games:spelling"))
    implementation(project(":feature:games:dice"))
