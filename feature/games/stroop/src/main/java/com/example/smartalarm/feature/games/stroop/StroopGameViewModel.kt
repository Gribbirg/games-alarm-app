...
/**
 * ViewModel экрана игры «Цвет и слово».
 *
 * Тонкий слой над чистой логикой [StroopGame]: держит таймер экрана
 * («м.сс»), пересоздаёт будильник при уходе с экрана без победы и
 * считает финальные очки по формуле игры-образца (арифметики).
 */
